...
def assert_create_exercise_response(
    ...
    assert_equal(response.exercise.estimated_time, request.estimated_time, "estimate_time")
...
def assert_get_exercise_response(
    ...
    """
    Проверяет, что ответ на получение упражения соответствует ответу на его создание.
    ...
    """
    assert_exercise(
        actual=get_exercise_response.exercise, expected=create_exercise_response.exercise
    )
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    """
    Функция для проверки ошибки, если упражение не найден на сервере.
